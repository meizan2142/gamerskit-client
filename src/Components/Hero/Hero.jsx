  ...
  <div className="container relative z-10 mx-auto flex flex-col lg:flex-row items-center gap-10">
    ...
    <div className="lg:w-1/2 text-center lg:text-left space-y-6">
      ...
      <p className="mt-2 text-base sm:text-lg lg:text-xl text-gray-200 leading-relaxed">
        Grab high quality esports jerseys and <br /> racing drift cars from Gamerskit!
      </p>

      <div className="mt-6 flex justify-center lg:justify-start">
        <NavLink to="/shop">
          <button className="px-6 py-3 rounded-full flex items-center gap-2 text-sm sm:text-base font-semibold 
