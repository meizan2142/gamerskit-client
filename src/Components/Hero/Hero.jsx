...
const Hero = () => {
    return (
        ...
        //             </p>
        //             <div className="mt-6">
        //                 <button className="px-4 py-2 rounded-xl text-sm sm:text-base hover:bg-[#FFB300] transition-all ease-in bg-black text-white outline-none">
        //                     Shop now
        //                 </button>
        //             </div>
        //         </div>
        ...
        >
            {/* Gradient Overlay: Yellow to Black (subtle) */}
            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12 relative z-10">
                ...
                {/* Right Slider Section (unchanged) */}
                <div className="lg:w-1/2 w-full mt-8 lg:mt-0">
                    <Swiper
                        modules={[Autoplay]}
                        autoplay={{ delay: 5000, disableOnInteraction: false }}
