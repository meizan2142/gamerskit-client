        ...
        <footer className="bg-white dark:bg-gray-900 mt-24">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="lg:flex lg:items-start lg:gap-8">
                    {/* Newsletter Section - Full width on mobile, 2 cols on desktop */}
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        {/* Newsletter Form - Full width on mobile, 3 cols on desktop */}
                            ...
                            <form className="w-full">
                                ...
                                <div className="border border-gray-100 p-2 focus-within:ring-3 sm:flex sm:items-center sm:gap-4 dark:border-gray-800">
                                    <input
                                        ...
                                        className="w-full border-none bg-transparent text-gray-900 outline-none dark:text-white"
                                    />
                                    <button
                        ...
                        {/* Links Grid - 2 cols on mobile, 1 col on sm, 5 cols on desktop */}
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                {['Marketing Calendar', 'SEO Infographics'].map((item) => (
                                    <li key={item}>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                                            {item}
                                        </a>
                        ...
                        {/* Social Links - Full width on mobile, 5 cols on desktop */}
