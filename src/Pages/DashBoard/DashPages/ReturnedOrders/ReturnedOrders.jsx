...
const ReturnedOrders = () => {
    ...
    const returned = allOrders.filter(p =>
        p?.status === "returned"
    );
    ...
    return (
        <div className="pt-2 md:pt-2 lg:pt-2 px-4 sm:px-6 md:px-10 space-y-6 md:space-y-10">
            <h1 className="font-bold text-3xl text-center">Returned Orders</h1>
            ...
            {returned.length > 0 ? (
                                ...
                                {returned
                                    ...
                                    .map((item, index) => (
                                        <tr key={item._id}>
                                            ...
                                            <td className="py-4 px-6 border-b text-center">
                                                <span className="inline-block px-3 py-1 bg-purple-100 text-black rounded-full text-sm">
                                                    {item.status}
                                                </span>
                                            </td>
                                        </tr>
                ...
                <div className="text-center min-h-[50vh] flex flex-col justify-center space-y-5">
                    <p className='font-bold text-xl'>No orders have been returned yet.</p>
                </div>
            )}
        </div>
    );
