  ...
  return (
    <div>
      ...
      <form
        ...
        className="flex flex-col mx-auto space-y-8 md:space-y-12">
        <Toaster />
        <fieldset className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 rounded-md shadow-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-4 col-span-full">
            ...
            <div className="col-span-full sm:col-span-3">
              <label htmlFor="price" className="text-sm sm:text-base font-bold">
                Price
              </label>
              <input
                id="price"
            ...
            <div className="col-span-full sm:col-span-3">
              ...
              <textarea
                ...
                className="w-full rounded-md border border-gray-300 text-black p-2 sm:p-3 outline-none min-h-[100px]"
                rows={4}
              />
            </div>
            ...
            {/* Sub Images URL */}
            <div className="col-span-full sm:col-span-3">
              <label htmlFor="img1" className="text-sm sm:text-base font-bold">
                Sub Images
              </label>
              <input
                name="img1"
                ...
                type="url"
                placeholder="1"
                className="w-full rounded-md border border-gray-300 text-black p-2 sm:p-3"
              />
            </div>
            <div className="col-span-full sm:col-span-3">
              <input
        ...
        <button
          type="submit"
          className="block bg-yellow-400 py-2 rounded-md text-base font-bold">
          Add Product
        </button>
      </form>
    </div>
