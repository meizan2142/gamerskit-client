            ...
            <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p className="text-gray-700"><span className="font-medium">Name:</span> {data.name}</p>
                        <p className="text-gray-700"><span className="font-medium">Email:</span> {data.email}</p>
                        <p className="text-gray-700"><span className="font-medium">Mobile:</span> {data.mobile}</p>
                        <p className="text-gray-700"><span className="font-medium">Address:</span> {data.address}</p>
                        <p className="text-gray-700"><span className="font-medium">District:</span> {data.district}</p>
                        <p className="text-gray-700"><span className="font-medium">Thana:</span> {data.thana}</p>
                    </div>
                </div>
